...
// Declare Class, name=useful one, not just popup
const gameFinishBanner = new Popup();
gameFinishBanner.setClickListener(()=>{
    startGame();
});

const gmaeField = new Field(CARROT_COUNT, BUG_COUNT);
gmaeField.setClickListender(onItemClick);
...
function stopGame() {
    ...
    stopGameTimer();
    hideGameButton();
    gameFinishBanner.ShowWithText('REAPLY???');
    sound.playAlert();
